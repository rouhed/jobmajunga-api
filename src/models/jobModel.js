...
class Job {
    ...
    static async findById(id) {
        const query = 'SELECT jo.*, rp.name, rp.name as company_name, rp.photo_url, rp.photo_url as logo_url, rp.sector, rp.description as company_desc FROM job_offers jo JOIN recruiter_profiles rp ON jo.recruiter_id = rp.user_id WHERE jo.id = ?';
